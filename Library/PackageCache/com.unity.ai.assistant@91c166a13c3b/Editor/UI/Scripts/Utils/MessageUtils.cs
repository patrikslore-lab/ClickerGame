...
namespace Unity.AI.Assistant.UI.Editor.Scripts.Utils
{
    internal static class MessageUtils
    {
        ...
        static readonly Regex k_ContextRegex = new($"{AssistantConstants.ContextTagEscaped}(.*){AssistantConstants.ContextTagEscaped}", RegexOptions.Compiled | RegexOptions.Singleline );
        ...
        public static void ProcessText(MessageModel message, ref IList<SourceBlock> sourceBlocks,
            out string messageContent, FootnoteFormat mode = FootnoteFormat.SpritesForText)
        {
            ...
            else if (message.Role == MessageModelRole.Assistant)
            {
